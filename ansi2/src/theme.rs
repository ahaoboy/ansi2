...
const VSCODE_COLOR: [(u8, u8, u8); 256] = [
    (0, 0, 0),
    (205, 49, 49),
    (13, 188, 121),
    (229, 229, 16),
...
const UBUNTU_COLOR: [(u8, u8, u8); 256] = [
    (1, 1, 1),
    (222, 56, 43),
    (57, 181, 74),
    (255, 199, 6),
...
const XTERM_COLOR: [(u8, u8, u8); 256] = [
    (0, 0, 0),
    (128, 0, 0),
    (0, 128, 0),
    (128, 128, 0),
...
const COLORS: [[(u8, u8, u8); 256]; 4] = [VSCODE_COLOR, UBUNTU_COLOR, VGA_COLOR, XTERM_COLOR];
...
pub trait ColorTable: Copy + Sized {
    ...
    fn get(&self, i: usize) -> (u8, u8, u8);
}

impl ColorTable for Theme {
    fn get(&self, i: usize) -> (u8, u8, u8) {
        COLORS[self.discriminant()][i]
    }
    fn black(&self) -> (u8, u8, u8) {
